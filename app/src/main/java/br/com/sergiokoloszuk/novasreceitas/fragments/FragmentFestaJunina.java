...
public class FragmentFestaJunina extends Fragment {

    public FragmentFestaJunina() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_festa_junina, container, false);

        ImageView imageViewPhoto = view.findViewById( R.id.img_cocada_de_colher);
        TextView textViewTitle = view.findViewById(R.id.txt_cocada_de_colher);
