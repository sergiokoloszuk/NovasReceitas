...
public class FragmentPiquenique extends Fragment {

    public FragmentPiquenique() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.fragment_piquenique, container, false);

        ImageView imageViewPhoto = view.findViewById( R.id.img_brownie_de_chocolate);
        TextView textViewTitle = view.findViewById(R.id.txt_brownie_de_chocolate);
