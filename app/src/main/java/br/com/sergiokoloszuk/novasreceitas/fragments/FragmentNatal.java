...
public class FragmentNatal extends Fragment {

    public FragmentNatal() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.fragment_natal, container, false);

        ImageView imageViewPhoto = view.findViewById( R.id.img_rabanada);
        TextView textViewTitle = view.findViewById(R.id.txt_rabanada);
